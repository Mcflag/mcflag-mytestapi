...
package cc.chen.mytestapi.content;
...
public class ContentItem {
	 ...
	 * 
	 * @param type
	 *            - One of {@link #CONTENT_TYPE_IMAGE} or
	 *            {@link #CONTENT_TYPE_TEXT}
	 * @param resourceId
	 *            - Resource ID to use for this item's content
	 */
	...
	/**
	 * Creates a ContentItem with the specified type, referencing an asset file
	 * path.
	 * 
	 * @param type
	 *            - One of {@link #CONTENT_TYPE_IMAGE} or
	 *            {@link #CONTENT_TYPE_TEXT}
	 * @param assetFilePath
	 *            - File path from the application's asset for this item's
	 *            content
	 */
	 ...
	 * 
	 * @param context
	 *            - Context to be used for fetching resources if needed
