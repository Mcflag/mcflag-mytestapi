...
/**
 * A simple ContentProvider which can serve files from this application's
 * assets. The majority of functionality is in
 * {@link #openAssetFile(android.net.Uri, String)}.
 */
public class AssetProvider extends ContentProvider {

	public static String CONTENT_URI = "cc.chen.mytestapi.provider";
