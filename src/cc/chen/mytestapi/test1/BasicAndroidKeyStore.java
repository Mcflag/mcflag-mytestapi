...
import cc.chen.mytestapi.utils.SecurityConstants;

@TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR2)
public class BasicAndroidKeyStore extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.basic_android_key_store_main);
		TextView sampleOutput = (TextView) findViewById(R.id.sample_output);
		sampleOutput.setText(Html.fromHtml(getString(R.string.basic_android_key_store_intro)));
		context = this;

		setAlias(SAMPLE_ALIAS);

		createButton = (Button) findViewById(R.id.btn_create_keys);
		...
		signButton = (Button) findViewById(R.id.btn_sign_data);
		...
		verityButton = (Button) findViewById(R.id.btn_verify_data);
		verityButton.setOnClickListener(new OnClickListener() {
	...
	public void createKeys(Context context) throws NoSuchProviderException, NoSuchAlgorithmException,
		...
		// You'll use the alias later to retrieve the key. It's a key for the
		// key!
				.setAlias(mAlias)
	 ...
	 */
	public String signData(String inputStr) throws KeyStoreException, UnrecoverableEntryException,
	 ...
	 *         not.
	 */
	public boolean verifyData(String input, String signatureStr) throws KeyStoreException, CertificateException,
