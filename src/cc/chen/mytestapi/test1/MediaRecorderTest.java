...
import cc.chen.mytestapi.media.CameraHelper;
...
public class MediaRecorderTest extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.media_recorder_main);
	 ...
	 * {@link android.media.MediaRecorder} and {@link android.hardware.Camera}.
	 * When not recording, it prepares the {@link android.media.MediaRecorder}
	...
	private boolean prepareVideoRecorder() {
		...
		Camera.Size optimalSize = CameraHelper.getOptimalPreviewSize(mSupportedPreviewSizes, mPreview.getWidth(),
				mPreview.getHeight());
