...
public class HorizontalList extends ViewGroup {
	...
	/**
	 * Remove all data, reset to initial state and attempt to refill Position of
	 * first item on screen in Adapter data set is maintained
	 */
	private void reset() {
	...
	protected void removeNonVisibleViewsLeftToRight(final int leftScreenEdge) {
		...
		while (firstChild != null
				&& firstChild.getRight() + ((MarginLayoutParams) firstChild.getLayoutParams()).rightMargin < leftScreenEdge) {
	...
	protected void removeNonVisibleViewsRightToLeft(final int rightScreenEdge) {
		...
		while (lastChild != null
				&& lastChild.getLeft() - ((MarginLayoutParams) lastChild.getLayoutParams()).leftMargin > rightScreenEdge) {
	...
	/**
	 * @param topline
	 *            Y coordinate of topline
	 * @param left
	 *            X coordinate where should we start layout
	 */
