...
/**
 * @author Martin Appl Set of handy mostly mathematical, geometric and generic
 *         java static methods
 */
public abstract class ToolBox {
	...
	/**
	 * Compute intersection point of two infinite lines. Each line is specified
	 * by two points
	 * 
	 * @param a1
	 *            line a
	 ...
	 * @return Intersection point
	 */
	public static PointF getLinesIntersection(float x1, float y1, float x2, float y2, float x3, float y3, float x4,
			float y4) {
		float a1 = y2 - y1;
		float b1 = x1 - x2;
	...
	/**
	 * Transforms MAC address in 00:11:22:33:44:55 format to byte array
	 * representation
	 * 
	 * @param MAC
	 * @return
	...
	public static String formatISODate(String isoDate) {
		...
		Date dtIn;
		try {
			dtIn = inFormat.parse(isoDate); // where dateString is a date in
											// ISO-8601 format
