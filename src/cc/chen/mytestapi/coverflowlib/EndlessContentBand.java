...
/**
 * @author Martin Appl DSP = device specific pixel TODO last poster is
 *         disappearing prematurely and reappearing late. Time to time container
 *         isn't drawn after Activity initialization.
 */
public class EndlessContentBand extends BasicContentBand {
	...
	public void fling(int velocityX, int velocityY) {
		...
		mScroller.fling(x, y, velocityX, velocityY, Integer.MIN_VALUE, Integer.MAX_VALUE, 0, bottomInPixels
				- getHeight());
