 ...
 */
public class BasicNotificationsTest extends Activity {
	/**
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.basic_notifications_test_main);
	...
	public void sendNotification(View view) {
		...
		/**
		 * Set the icon that will appear in the notification bar. This icon also
		 * appears in the lower right hand corner of the notification itself.
		 * 
		 * Important note: although you can use any drawable as the small icon,
		 * Android design guidelines state that the icon should be simple and
		 * monochrome. Full-color bitmaps or busy images don't render well on
		 * smaller screens and can end up confusing the user.
		 */
