 ...
 * action bar buttons.
 */
public class ImmersiveModeTest extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.immersive_mode_test_main);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.immersive_mode_test_menu, menu);
		return true;
	}
