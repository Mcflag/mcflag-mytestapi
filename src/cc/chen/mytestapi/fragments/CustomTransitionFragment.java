...
import cc.chen.mytestapi.utils.ChangeColor;
...
public class CustomTransitionFragment extends Fragment implements View.OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(R.layout.custom_transition_test_fragment_custom_transition, container, false);
	}
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		mScenes = new Scene[] { Scene.getSceneForLayout(container, R.layout.custom_transition_test_scene1, context),
				Scene.getSceneForLayout(container, R.layout.custom_transition_test_scene2, context),
				Scene.getSceneForLayout(container, R.layout.custom_transition_test_scene3, context), };
	...
	public void onClick(View v) {
		...
		case R.id.show_next_scene: {
			...
			// Pass the custom Transition as second argument for
