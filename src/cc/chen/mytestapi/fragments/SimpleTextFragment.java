...
package cc.chen.mytestapi.fragments;
...
/**
 * Simple fragment containing only a TextView. Used by TextPagerAdapter to
 * create tutorial-style pages for apps.
 */
public class SimpleTextFragment extends Fragment {
	...
	// Contains a resource ID for the text that will be displayed by this
	// fragment.
	int mTextId = -1;

	// Keys which will be used to store/retrieve text passed in via
	// setArguments.
	public static final String TEXT_KEY = "text";
	public static final String TEXT_ID_KEY = "text_id";

	// For situations where the app wants to modify text at Runtime, exposing
	// the TextView.
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		// Before initializing the textView, check if any arguments were
		// provided via setArguments.
		processArguments();
	...
	/**
	 * Changes the text for this TextView, according to the resource ID
	 * provided.
	 * 
	 * @param stringId
	 *            A resource ID representing the text content for this
	 *            Fragment's TextView.
	 */
