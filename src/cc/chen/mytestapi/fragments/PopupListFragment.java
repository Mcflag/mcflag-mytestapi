...
public class PopupListFragment extends ListFragment implements View.OnClickListener {
	...
	private void showPopupMenu(View view) {
		...
		popup.getMenuInflater().inflate(R.menu.actionbar_compat_listpopup_menu, popup.getMenu());
	...
	class PopupAdapter extends ArrayAdapter<String> {
		...
		PopupAdapter(ArrayList<String> items) {
			super(getActivity(), R.layout.actionbar_compat_listpopup_item, android.R.id.text1, items);
		}
