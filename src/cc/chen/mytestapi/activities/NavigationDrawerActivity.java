...
package cc.chen.mytestapi.activities;
...
import cc.chen.mytestapi.adapter.PlanetAdapter;
...
public class NavigationDrawerActivity extends Activity implements PlanetAdapter.OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.navigation_drawer_activity_navigation_drawer);
	...
	public static class PlanetFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			View rootView = inflater.inflate(R.layout.navigation_drawer_fragment_planet, container, false);
